...
(function (e) {
    ...
    "use strict";
    if (!e.jstree) {
        var i = 0, s = !1, r = !1, n = !1, a = [], d = e("script:last").attr("src"), o = document,
            c = o.createElement("LI"), l, h;
        c.setAttribute("role", "treeitem"), l = o.createElement("I"), l.className = "jstree-icon jstree-ocl", c.appendChild(l), l = o.createElement("A"), l.className = "jstree-anchor", l.setAttribute("href", "#"), h = o.createElement("I"), h.className = "jstree-icon jstree-themeicon", l.appendChild(h), c.appendChild(l), l = h = null, e.jstree = {
            version: "3.0.4",
            defaults: {plugins: []},
            plugins: {},
            ...
            var s = "string" == typeof i, r = Array.prototype.slice.call(arguments, 1), n = null;
            return this.each(function () {
                var a = e.jstree.reference(this), d = s && a ? a[i] : null;
            ...
            plugin: function (t, i) {
                ...
                var s;
                try {
                    if (this._model.data[t]) t = this._model.data[t]; else if (((s = e(t, this.element)).length || (s = e("#" + t.replace(e.jstree.idregex, "\\$&"), this.element)).length) && this._model.data[s.closest(".jstree-node").attr("id")]) t = this._model.data[s.closest(".jstree-node").attr("id")]; else {
                ...
                if (t = this.get_node(t, !0), t[0] === this.element[0]) {
                    s = this._firstChild(this.get_container_ul()[0]);
                    while (s && 0 === s.offsetHeight) s = this._nextSibling(s);
                    return s ? e(s) : !1
                }
                if (!t || !t.length) return !1;
                if (i) {
                    s = t[0];
                    do s = this._nextSibling(s); while (s && 0 === s.offsetHeight);
                    return s ? e(s) : !1
                }
                if (t.hasClass("jstree-open")) {
                    s = this._firstChild(t.children(".jstree-children")[0]);
                    while (s && 0 === s.offsetHeight) s = this._nextSibling(s);
                    if (null !== s) return e(s)
                }
                s = t[0];
                do s = this._nextSibling(s); while (s && 0 === s.offsetHeight);
                return null !== s ? e(s) : t.parentsUntil(".jstree", ".jstree-node").next(".jstree-node:visible").eq(0)
            }, get_prev_dom: function (t, i) {
                var s;
                if (t = this.get_node(t, !0), t[0] === this.element[0]) {
                    s = this.get_container_ul()[0].lastChild;
                    while (s && 0 === s.offsetHeight) s = this._previousSibling(s);
                    return s ? e(s) : !1
                }
                if (!t || !t.length) return !1;
                if (i) {
                    s = t[0];
                    do s = this._previousSibling(s); while (s && 0 === s.offsetHeight);
                    return s ? e(s) : !1
                }
                s = t[0];
                do s = this._previousSibling(s); while (s && 0 === s.offsetHeight);
                if (null !== s) {
                    t = e(s);
                    while (t.hasClass("jstree-open")) t = t.children(".jstree-children:eq(0)").children(".jstree-node:visible:last");
                    return t
                }
                ...
                var s = this.settings.core.data, r;
                ...
                var r = i.is("ul") ? i.children() : i, n = t.id, a = [], d = [], o = this._model.data, c = o[n],
                    l = this._data.core.selected.length, h, _, u;
            ...
            }, _append_json_data: function (t, i, s, r) {
                ...
                var n = null, a = {
                    ...
                    e.data && (e = e.data);
                    var i = e.dat, s = e.par, r = [], n = [], a = [], d = e.df, o = e.t_id, c = e.t_cnt, l = e.m,
                        h = l[s], _ = e.sel, u, g, f, p, m = function (e, i, s) {
                            s = s ? s.concat() : [], i && s.unshift(i);
                            var r = "" + e.id, n, o, c, h, _ = {
                                id: r,
                                text: e.text || "",
                            ...
                            if (e && e.data && e.data.jstree && e.data.jstree.icon && (_.icon = e.data.jstree.icon), e && e.data && (_.data = e.data, e.data.jstree)) for (n in e.data.jstree) e.data.jstree.hasOwnProperty(n) && (_.state[n] = e.data.jstree[n]);
                            if (e && "object" == typeof e.state) for (n in e.state) e.state.hasOwnProperty(n) && (_.state[n] = e.state[n]);
                            if (e && "object" == typeof e.li_attr) for (n in e.li_attr) e.li_attr.hasOwnProperty(n) && (_.li_attr[n] = e.li_attr[n]);
                            if (_.li_attr.id || (_.li_attr.id = r), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (_.a_attr[n] = e.a_attr[n]);
                            ...
                            if (e && e.id && (g.id = "" + e.id), e && e.text && (g.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (g.icon = e.data.jstree.icon), e && e.data && (g.data = e.data, e.data.jstree)) for (n in e.data.jstree) e.data.jstree.hasOwnProperty(n) && (g.state[n] = e.data.jstree[n]);
                            if (e && "object" == typeof e.state) for (n in e.state) e.state.hasOwnProperty(n) && (g.state[n] = e.state[n]);
                            if (e && "object" == typeof e.li_attr) for (n in e.li_attr) e.li_attr.hasOwnProperty(n) && (g.li_attr[n] = e.li_attr[n]);
                            if (g.li_attr.id && !g.id && (g.id = "" + g.li_attr.id), g.id || (g.id = r), g.li_attr.id || (g.li_attr.id = g.id), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (g.a_attr[n] = e.a_attr[n]);
                    ...
                    if (i.length && i[0].id !== t && i[0].parent !== t) {
                        ...
                        p = {cnt: c, mod: l, sel: _, par: s, dpc: n, add: a}
                    } else {
                    ...
                    if (this._cnt = t.cnt, this._model.data = t.mod, i) {
                        var r, n, a = t.add, d = t.sel, o = this._data.core.selected.slice(), c = this._model.data;
                ...
                if (this.settings.core.worker && window.Blob && window.URL && window.Worker) try {
                    null === this._wrk && (this._wrk = window.URL.createObjectURL(new window.Blob(["self.onmessage = " + ("" + d).replace(/return ([^;}]+)[\s;}]+$/, "postMessage($1);}")], {type: "text/javascript"}))), !this._data.core.working || r ? (this._data.core.working = !0, n = new window.Worker(this._wrk), n.onmessage = e.proxy(function (e) {
                        o.call(this, e.data, !0), this._data.core.worker_queue.length ? this._append_json_data.apply(this, this._data.core.worker_queue.shift()) : this._data.core.working = !1
                    }, this), a.par ? n.postMessage(a) : this._data.core.worker_queue.length ? this._append_json_data.apply(this, this._data.core.worker_queue.shift()) : this._data.core.working = !1) : this._data.core.worker_queue.push([t, i, s, !0])
                } catch (c) {
                ...
                if (l = e.vakata.attributes(i, !0), e.each(l, function (i, s) {
                    ...
                    })), l = i.children("a:eq(0)").length ? i.children("a:eq(0)").clone() : i.clone(), l.children("ins, i, ul").remove(), l = l.html(), l = e("<div />").html(l), o.text = this.settings.core.force_text ? l.text() : l.html(), l = i.data(), o.data = l ? e.extend(!0, {}, l) : null, o.state.opened = i.hasClass("jstree-open"), o.state.selected = i.children("a").hasClass("jstree-clicked"), o.state.disabled = i.children("a").hasClass("jstree-disabled"), o.data && o.data.jstree) for (c in o.data.jstree) o.data.jstree.hasOwnProperty(c) && (o.state[c] = o.data.jstree[c]);
                ...
                s = s ? s.concat() : [], i && s.unshift(i);
                var r = "" + e.id, n = this._model.data, a = this._model.default_state, d, o, c, l, h = {
                    id: r,
                    text: e.text || "",
                    icon: e.icon !== t ? e.icon : !0,
                    parent: i,
                ...
                if (h.li_attr.id || (h.li_attr.id = r), e && "object" == typeof e.a_attr) for (d in e.a_attr) e.a_attr.hasOwnProperty(d) && (h.a_attr[d] = e.a_attr[d]);
                ...
                s = s ? s.concat() : [], i && s.unshift(i);
                var r = !1, n, a, d, o, c = this._model.data, l = this._model.default_state, h;
                ...
                if (e && e.id && (h.id = "" + e.id), e && e.text && (h.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (h.icon = e.data.jstree.icon), e && e.data && (h.data = e.data, e.data.jstree)) for (n in e.data.jstree) e.data.jstree.hasOwnProperty(n) && (h.state[n] = e.data.jstree[n]);
                if (e && "object" == typeof e.state) for (n in e.state) e.state.hasOwnProperty(n) && (h.state[n] = e.state[n]);
                if (e && "object" == typeof e.li_attr) for (n in e.li_attr) e.li_attr.hasOwnProperty(n) && (h.li_attr[n] = e.li_attr[n]);
                if (h.li_attr.id && !h.id && (h.id = "" + h.li_attr.id), h.id || (h.id = r), h.li_attr.id || (h.li_attr.id = h.id), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (h.a_attr[n] = e.a_attr[n]);
                if (e && e.children && e.children.length) {
                ...
                var e = this._model.force_full_redraw ? this._model.data["#"].children.concat([]) : this._model.changed.concat([]),
                    t = document.createElement("UL"), i, s, r, n = this._data.core.focused;
                ...
                for (o in r.li_attr) if (r.li_attr.hasOwnProperty(o)) {
                    if ("id" === o) continue;
                ...
                for (l in r.a_attr) if (r.a_attr.hasOwnProperty(l)) {
                    if ("href" === l && "#" === r.a_attr[l]) continue;
                    "class" !== l ? t.childNodes[1].setAttribute(l, r.a_attr[l]) : _ += " " + r.a_attr[l]
                }
                if (_.length && (t.childNodes[1].className = "jstree-anchor " + _), (r.icon && r.icon !== !0 || r.icon === !1) && (r.icon === !1 ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === r.icon.indexOf("/") && -1 === r.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + r.icon + " jstree-themeicon-custom" : (t.childNodes[1].childNodes[0].style.backgroundImage = "url(" + r.icon + ")", t.childNodes[1].childNodes[0].style.backgroundPosition = "center center", t.childNodes[1].childNodes[0].style.backgroundSize = "100%", t.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? t.childNodes[1].appendChild(u.createTextNode(r.text)) : t.childNodes[1].innerHTML += r.text, i && r.children.length && r.state.opened && r.state.loaded) {
                ...
                if (d && t.appendChild(d), !s) {
                    for (n || (n = this.element[0]), o = 0, l = n.childNodes.length; l > o; o++) if (n.childNodes[o] && n.childNodes[o].className && -1 !== n.childNodes[o].className.indexOf("jstree-children")) {
                        m = n.childNodes[o];
                        break
                    }
                ...
                if (this.is_loaded(i)) d = this.get_node(i, !0), o = this, d.length && (i.children.length && !this._firstChild(d.children(".jstree-children")[0]) && (i.state.opened = !0, this.redraw_node(i, !0), d = this.get_node(i, !0)), r ? (this.trigger("before_open", {node: i}), d.children(".jstree-children").css("display", "none").end().removeClass("jstree-closed").addClass("jstree-open").attr("aria-expanded", !0).children(".jstree-children").stop(!0, !0).slideDown(r, function () {
                    this.style.display = "", o.trigger("after_open", {node: i})
                })) : (this.trigger("before_open", {node: i}), d[0].className = d[0].className.replace("jstree-closed", "jstree-open"), d[0].setAttribute("aria-expanded", !0))), i.state.opened = !0, s && s.call(this, i, !0), d.length || this.trigger("before_open", {node: i}), this.trigger("open_node", {node: i}), r && d.length || this.trigger("after_open", {node: i}); else {
                ...
                }) : (d[0].className = d[0].className.replace("jstree-open", "jstree-closed"), d.attr("aria-expanded", !1).children(".jstree-children").remove())), i.state.opened = !1, this.trigger("close_node", {node: i}), s && d.length || this.trigger("after_close", {node: i}), t) : !1
                ...
                var s = "#" === e.id ? this.get_container_ul() : this.get_node(e, !0), r, n, a;
                if (!s.length) {
                ...
                var s = "#" === t.id ? this.get_container_ul() : this.get_node(t, !0), r = this, n, a;
                if (!s.length) {
                ...
                if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent)) if (i.shiftKey) {
                    var s = this.get_node(e).id, r = this._data.core.last_clicked.id,
                        n = this.get_node(this._data.core.last_clicked.parent).children, a = !1, d, o;
                ...
                var t = this._data.core.selected.concat([]), i, s;
                ...
                var i = this.get_selected(!0), s = {}, r, n, a, d;
                for (r = 0, n = i.length; n > r; r++) s[i[r].id] = i[r];
                for (r = 0, n = i.length; n > r; r++) for (a = 0, d = i[r].children_d.length; d > a; a++) s[i[r].children_d[a]] && delete s[i[r].children_d[a]];
                i = [];
                ...
                var i = this.get_selected(!0), s = [], r, n;
                ...
                if (t = this.get_node(t), !t || "#" === t.id) return !1;
                var i = [], s = [], r = this._data.core.selected.concat([]);
                ...
                if (t && t.flat ? s.parent = e.parent : s.children = [], !t || !t.no_state) for (r in e.state) e.state.hasOwnProperty(r) && (s.state[r] = e.state[r]);
                if (t && t.no_id && (delete s.id, s.li_attr && s.li_attr.id && delete s.li_attr.id), t && t.flat && "#" !== e.id && i.push(s), !t || !t.no_children) for (r = 0, n = e.children.length; n > r; r++) t && t.flat ? this.get_json(e.children[r], t, i) : s.children.push(this.get_json(e.children[r], t));
                ...
                s || (s = {text: this.get_string("New node")}), s.text === t && (s.text = this.get_string("New node"));
                var d, o, c, l;
                ...
                var a = t.match(/^move_node|copy_node|create_node$/i) ? s : i, d = this.settings.core.check_callback;
                return "move_node" !== t && "copy_node" !== t || n && n.is_multi || i.id !== s.id && e.inArray(i.id, s.children) !== r && -1 === e.inArray(s.id, i.children_d) ? (a && a.data && (a = a.data), a && a.functions && (a.functions[t] === !1 || a.functions[t] === !0) ? (a.functions[t] === !1 && (this._data.core.last_error = {
                    ...
                    data: JSON.stringify({chk: t, pos: r, obj: i && i.id ? i.id : !1, par: s && s.id ? s.id : !1})
                ...
                return a.length ? (s = a, n = this, r = "move_node", this.trigger("cut", {node: i}), t) : !1
            }, copy: function (i) {
                if (i || (i = this._data.core.selected.concat()), e.isArray(i) || (i = [i]), !i.length) return !1;
                var a = [], d, o, c;
                for (o = 0, c = i.length; c > o; o++) d = this.get_node(i[o]), d && d.id && "#" !== d.id && a.push(d);
                return a.length ? (s = a, n = this, r = "copy_node", this.trigger("copy", {node: i}), t) : !1
            }, get_buffer: function () {
                return {mode: r, node: s, inst: n}
            }, can_paste: function () {
                return r !== !1 && s !== !1
            }, paste: function (e, i) {
                ...
                var r = this._data.core.rtl, n = this.element.width(), a = i.children(".jstree-anchor"),
                    d = e("<span>"), o = s, c = e("<div />", {
                        css: {
                            position: "absolute",
                            top: "-200px",
                            left: r ? "0px" : "-1000px",
                        ...
                        blur: e.proxy(function () {
                            var t = d.children(".jstree-rename-input"), s = t.val();
            ...
            return t && t.attributes && e.each(t.attributes, function (t, r) {
                -1 === e.inArray(r.name.toLowerCase(), ["style", "contenteditable", "hasfocus", "tabindex"]) && null !== r.value && "" !== e.trim(r.value) && (i ? s[r.name] = r.value : s.push(r.name))
            }), s
        }, e.vakata.array_unique = function (e) {
            var t = [], i, s, r;
            for (i = 0, r = e.length; r > i; i++) {
                for (s = 0; i >= s; s++) if (e[i] === e[s]) break;
                s === i && t.push(e[i])
            }
            return t
        ...
        _.className = "jstree-icon jstree-checkbox", e.jstree.defaults.checkbox = {
            ...
            this.bind = function () {
                s.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", e.proxy(function () {
                    ...
                    var i = this._model.data, s = i[t.parent], r = t.nodes, n, a;
                    ...
                    var s = this._model.data, r = s[i.parent], n = i.nodes, a = [], d, o, c, l, h, _,
                        u = this.settings.checkbox.cascade, g = this.settings.checkbox.tie_selection;
                    if (-1 !== u.indexOf("down")) if (r.state[g ? "selected" : "checked"]) {
                    ...
                    } else for (o = 0, c = n.length; c > o; o++) if (s[n[o]].state[g ? "selected" : "checked"]) {
                    ...
                    var s = i.node, r = this._model.data, n = this.get_node(s.parent), a = this.get_node(s, !0), d, o,
                        c, l, h = this.settings.checkbox.cascade, _ = this.settings.checkbox.tie_selection;
                    if (-1 !== h.indexOf("down")) for (this._data[_ ? "core" : "checkbox"].selected = e.vakata.array_unique(this._data[_ ? "core" : "checkbox"].selected.concat(s.children_d)), d = 0, o = s.children_d.length; o > d; d++) l = r[s.children_d[d]], l.state[_ ? "selected" : "checked"] = !0, l && l.original && l.original.state && l.original.state.undetermined && (l.original.state.undetermined = !1);
                    ...
                    var i = this.get_node("#"), s = this._model.data, r, n, a;
                    ...
                    var s = i.node, r = this.get_node(s, !0), n, a, d, o = this.settings.checkbox.cascade,
                        c = this.settings.checkbox.tie_selection;
                    if (s && s.original && s.original.state && s.original.state.undetermined && (s.original.state.undetermined = !1), -1 !== o.indexOf("down")) for (n = 0, a = s.children_d.length; a > n; n++) d = this._model.data[s.children_d[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                    if (-1 !== o.indexOf("up")) for (n = 0, a = s.parents.length; a > n; n++) d = this._model.data[s.parents[n]], d.state[c ? "selected" : "checked"] = !1, d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1), d = this.get_node(s.parents[n], !0), d && d.length && d.children(".jstree-anchor").removeClass(c ? "jstree-clicked" : "jstree-checked");
                    ...
                    var i = this.get_node(t.parent), s = this._model.data, r, n, a, d,
                    ...
                    var s = i.is_multi, r = i.old_parent, n = this.get_node(i.parent), a = this._model.data, d, o, c, l,
                        h, _ = this.settings.checkbox.tie_selection;
                    if (!s) {
                        d = this.get_node(r);
                        while (d && "#" !== d.id) {
                    ...
                    while (d && "#" !== d.id) {
                        for (o = 0, c = 0, l = d.children.length; l > c; c++) o += a[d.children[c]].state[_ ? "selected" : "checked"];
                        if (o === l) d.state[_ ? "selected" : "checked"] || (d.state[_ ? "selected" : "checked"] = !0, this._data[_ ? "core" : "checkbox"].selected.push(d.id), h = this.get_node(d, !0), h && h.length && h.children(".jstree-anchor").addClass(_ ? "jstree-clicked" : "jstree-checked")); else {
                ...
                var t, i, s = this._model.data, r = this.settings.checkbox.tie_selection,
                    n = this._data[r ? "core" : "checkbox"].selected, a = [], d = this;
                ...
                for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function () {
                    var e = d.get_node(this), r;
                    if (e.state.loaded) for (t = 0, i = e.children_d.length; i > t; t++) r = s[e.children_d[t]], !r.state.loaded && r.original && r.original.state && r.original.state.undetermined && r.original.state.undetermined === !0 && (a.push(r.id), a = a.concat(r.parents)); else e.original && e.original.state && e.original.state.undetermined && e.original.state.undetermined === !0 && (a.push(e.id), a = a.concat(e.parents))
                ...
                if (t = s.redraw_node.call(this, t, i, r)) {
                    var n, a, d = null;
                    for (n = 0, a = t.childNodes.length; a > n; n++) if (t.childNodes[n] && t.childNodes[n].className && -1 !== t.childNodes[n].className.indexOf("jstree-anchor")) {
                        d = t.childNodes[n];
                        break
                    }
                ...
                t = this.get_node(t);
                var i = this.settings.checkbox.cascade, s, r, n = this.settings.checkbox.tie_selection,
                    a = this._data[n ? "core" : "checkbox"].selected, d = this._model.data;
                ...
                var i = this.get_checked(!0), s = {}, r, n, a, d;
                for (r = 0, n = i.length; n > r; r++) s[i[r].id] = i[r];
                for (r = 0, n = i.length; n > r; r++) for (a = 0, d = i[r].children_d.length; d > a; a++) s[i[r].children_d[a]] && delete s[i[r].children_d[a]];
                i = [];
                for (r in s) s.hasOwnProperty(r) && i.push(r);
                ...
                var i = this.get_checked(!0), s = [], r, n;
                for (r = 0, n = i.length; n > r; r++) i[r].children.length || s.push(i[r].id);
                return t ? e.map(s, e.proxy(function (e) {
                    return this.get_node(e)
                }, this)) : s
            ...
            this.bind = function () {
                ...
                if (i = this.get_node(i), !i || "#" === i.id) return !1;
                var a = this.settings.contextmenu, d = this.get_node(i, !0), o = d.children(".jstree-anchor"), c = !1,
                    l = !1;
                ...
                e(document).one("context_show.vakata.jstree", e.proxy(function (t, i) {
                    ...
                    x: i,
                    y: s
                }, r), this.trigger("show_contextmenu", {node: t, x: i, y: s})
            }
        }, function (e) {
            var i = !1,
                s = {element: !1, reference: !1, position_x: 0, position_y: 0, items: [], html: "", is_visible: !1};
            e.vakata.context = {
                settings: {hide_onmouseleave: 0, icons: !0}, _trigger: function (t) {
                    ...
                    if (t = e(t), t.length && t.children("ul").length) {
                        var s = t.children("ul"), r = t.offset().left + t.outerWidth(), n = t.offset().top,
                            a = s.width(), d = s.height(), o = e(window).width() + e(window).scrollLeft(),
                    ...
                    s.is_visible && (s.element.hide().find("ul").hide().end().find(":focus").blur().end().detach(), s.is_visible = !1, e.vakata.context._trigger("hide"))
                }
            }, e(function () {
            ...
            this.bind = function () {
                s.bind.call(this), this.element.on("mousedown.jstree touchstart.jstree", ".jstree-anchor", e.proxy(function (i) {
                    var s = this.get_node(i.target), r = this.is_selected(s) ? this.get_selected().length : 1;
            ...
            var i = !1, s = !1, r = !1, n = e('<div id="jstree-marker">&#160;</div>').hide();
            e(document).on("dnd_start.vakata.jstree", function (e, t) {
                ...
                if (r && clearTimeout(r), d && d.data && d.data.jstree && (!d.event.target.id || "jstree-marker" !== d.event.target.id)) {
                    var o = e.jstree.reference(d.event.target), c = !1, l = !1, h = !1, _, u, g, f, p, m, v, j, k, y, x,
                        b, w, C;
                    if (o && o._data && o._data.dnd) if (n.attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), d.helper.children().attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy:eq(0)")[d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "show" : "hide"](), d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                        ...
                        for (v = !0, j = 0, k = d.data.nodes.length; k > j; j++) if (v = v && o.check(d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "copy_node" : "move_node", d.data.origin && d.data.origin !== o ? d.data.origin.get_node(d.data.nodes[j]) : d.data.nodes[j], "#", "last", {
                                dnd: !0,
                                ref: o.get_node("#"),
                                pos: "i",
                                is_multi: d.data.origin && d.data.origin !== o,
                ...
                if (r && clearTimeout(r), a && a.data && a.data.jstree) {
                    ...
                    if (i) {
                        ...
                        for (i.ins[a.data.origin && (a.data.origin.settings.dnd.always_copy || a.data.origin.settings.dnd.copy && (a.event.metaKey || a.event.ctrlKey)) ? "copy_node" : "move_node"](c, i.par, i.pos), d = 0, o = c.length; o > d; d++) c[d].instance && (c[d].instance = null)
            ...
            e.vakata.dnd = {
                settings: {
                    ...
                    i.helper && i.helper.remove(), i.scroll_i && (clearInterval(i.scroll_i), i.scroll_i = !1), i = {
                        ...
                        scroll_i: !1,
                        is_touch: !1
                    }, e(document).off("mousemove.vakata.jstree touchmove.vakata.jstree", e.vakata.dnd.drag), e(document).off("mouseup.vakata.jstree touchend.vakata.jstree", e.vakata.dnd.stop)
                }, _scroll: function (t) {
                    ...
                    if (t === !0) return !1;
                    var s = i.scroll_e.scrollTop(), r = i.scroll_e.scrollLeft();
                    ...
                    return i.init_x = t.pageX, i.init_y = t.pageY, i.data = s, i.is_down = !0, i.element = t.currentTarget, i.target = t.target, i.is_touch = "touchstart" === t.type, r !== !1 && (i.helper = e("<div id='vakata-dnd'></div>").html(r).css({
                        ...
                        lineHeight: "16px",
                        zIndex: "10000"
                    })), e(document).on("mousemove.vakata.jstree touchmove.vakata.jstree", e.vakata.dnd.drag), e(document).on("mouseup.vakata.jstree touchend.vakata.jstree", e.vakata.dnd.stop), !1
                }, drag: function (s) {
                    if ("touchmove" === s.type && s.originalEvent && s.originalEvent.changedTouches && s.originalEvent.changedTouches[0] && (s.pageX = s.originalEvent.changedTouches[0].pageX, s.pageY = s.originalEvent.changedTouches[0].pageY, s.target = document.elementFromPoint(s.originalEvent.changedTouches[0].pageX - window.pageXOffset, s.originalEvent.changedTouches[0].pageY - window.pageYOffset)), i.is_down) {
                        ...
                        var r = !1, n = !1, a = !1, d = !1, o = !1, c = !1, l = !1, h = !1, _ = !1, u = !1;
            ...
            this.bind = function () {
                s.bind.call(this), this._data.search.str = "", this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this.element.on("before_open.jstree", e.proxy(function (t, i) {
                    var s, r, n, a = this._data.search.res, d = [], o = e();
                ...
                i = "" + i;
                var r = this.settings.search, n = r.ajax ? r.ajax : !1, a = null, d = [], o = [], c, l;
            ...
            e.vakata.search = function (e, t, i) {
                ...
                var s = i.location || 0, r = i.distance || 100, n = i.threshold || .6, a = e.length, d, o, c, l;
                return a > 32 && (i.fuzzy = !1), i.fuzzy && (d = 1 << a - 1, o = function () {
                    ...
                    var r, l, h = t.length, _ = n, u = t.indexOf(e, s), g, f, p = a + h, m, v, j, k, y, x = 1, b = [];
                    for (-1 !== u && (_ = Math.min(c(0, u), _), u = t.lastIndexOf(e, s + a), -1 !== u && (_ = Math.min(c(0, u), _))), u = -1, r = 0; a > r; r++) {
                        ...
                        for (p = f, v = Math.max(1, s - f + 1), j = Math.min(s + f, h) + a, k = Array(j + 2), k[j + 1] = (1 << r) - 1, l = j; l >= v; l--) if (y = o[t.charAt(l - 1)], k[l] = 0 === r ? (1 | k[l + 1] << 1) & y : (1 | k[l + 1] << 1) & y | (1 | (m[l + 1] | m[l]) << 1) | m[l + 1], k[l] & d && (x = c(r, l - 1), _ >= x)) {
            ...
            this.bind = function () {
                ...
                var s, r;
                if (t = this.get_node(t), t && t.children && t.children.length && (t.children.sort(e.proxy(this.settings.sort, this)), i)) for (s = 0, r = t.children_d.length; r > s; s++) this.sort(t.children_d[s], !1)
            }
        };
        var u = !1;
        e.jstree.defaults.state = {
            ...
            this.bind = function () {
                ...
                return t && t.ttl && t.sec && +new Date - t.sec > t.ttl ? !1 : (t && t.state && (t = t.state), t && e.isFunction(this.settings.state.filter) && (t = this.settings.state.filter.call(this, t)), t ? (this.element.one("set_state.jstree", function (i, s) {
                    s.instance.trigger("restore_state", {state: e.extend(!0, {}, t)})
        ...
        }(e), e.jstree.defaults.types = {"#": {}, "default": {}}, e.jstree.plugins.types = function (i, s) {
            this.init = function (e, i) {
                var r, n;
                if (i && i.types && i.types["default"]) for (r in i.types) if ("default" !== r && "#" !== r && i.types.hasOwnProperty(r)) for (n in i.types["default"]) i.types["default"].hasOwnProperty(n) && i.types[r][n] === t && (i.types[r][n] = i.types["default"][n]);
                ...
                this.element.on("model.jstree", e.proxy(function (e, i) {
                    var s = this._model.data, r = i.nodes, n = this.settings.types, a, d, o = "default";
                ...
                var n, a, d = this._model.data, o = i ? e.extend(!0, {}, i, {no_id: !1}) : {},
                    c = s.get_json.call(this, t, o, r);
                if (c === !1) return !1;
                if (e.isArray(c)) for (n = 0, a = c.length; a > n; n++) c[n].type = c[n].id && d[c[n].id] && d[c[n].id].type ? d[c[n].id].type : "default", i && i.no_id && (delete c[n].id, c[n].li_attr && c[n].li_attr.id && delete c[n].li_attr.id); else c.type = c.id && d[c.id] && d[c.id].type ? d[c.id].type : "default", i && i.no_id && (c = this._delete_ids(c));
                return c
                ...
                var o = r && r.id ? e.jstree.reference(r.id) : null, c, l, h, _;
            ...
            this.check = function (t, i, r, n, a) {
                ...
                var d = "rename_node" === t ? n : i.text, o = [], c = this.settings.unique.case_sensitive,
                    l = this._model.data, h, _;
                ...
                if (!r || r.text === t) {
                    ...
                    r || (r = {});
                    var o, c, l, h, _, u = this._model.data, g = this.settings.unique.case_sensitive,
        ...
        g.setAttribute("unselectable", "on"), g.className = "jstree-wholerow", g.innerHTML = "&#160;", e.jstree.plugins.wholerow = function (t, i) {
            this.bind = function () {
                ...
                if (t = i.redraw_node.call(this, t, s, r)) {
                    var n = g.cloneNode(!0);
                    -1 !== e.inArray(t.id, this._data.core.selected) && (n.className += " jstree-wholerow-clicked"), t.insertBefore(n, t.childNodes[0])
                }
                return t
            }
        }, function (e) {
            if (document.registerElement) {
                ...
                t.createdCallback = function () {
                    ...
                    for (i in e.jstree.plugins) e.jstree.plugins.hasOwnProperty(i) && this.attributes[i] && (t.plugins.push(i), this.getAttribute(i) && JSON.parse(this.getAttribute(i)) && (t[i] = JSON.parse(this.getAttribute(i))));
