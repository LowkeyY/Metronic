(function(){
    ...
    function getTabs(moduleId){
        return  '<div class="row" id="module_'+moduleId+'"> ' + 
                ...
                '						<div class="tab-pane" id="'+moduleId+'_1">' + getTableBar(moduleId+'_1') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_2">' + getTableBar(moduleId+'_2') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_3">' + getTableBar(moduleId+'_3') +
                '						</div>' + 
                '						<div class="tab-pane" id="'+moduleId+'_4">' + getTableBar(moduleId+'_4') + 
                '						</div>' + 
                '					</div>' + 
                '				</div>' + 
                '			</div>' + 
            ...
            appendHtml(getTabs(conf.id) , function(){
                ...
                $('#'+conf.id).on('click', 'li > a', function (el) {
                    ...
                    if(clickId && (selector = $(clickId))){
                        ...
                        } else if(clickId.endsWith("_3|_4")){
